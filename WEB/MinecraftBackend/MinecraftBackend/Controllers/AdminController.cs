...
using System.IO; // Cần thêm thư viện này để xử lý file
...
namespace MinecraftBackend.Controllers
{
    public class AdminController : Controller
    {
        ...
        // --- ITEMS MANAGEMENT (Có Phân Trang) ---
        ...
        public async Task<IActionResult> UserDetails(string id)
        {
            ...
            // Lấy danh sách ảnh để hiển thị trong kho đồ
            ...
            int page = 1)
        {
            ...
            ViewBag.Types = new List<string> { "LOGIN", "REGISTER", "TRANSACTION", "GIFT", "CRAFT", "BUY", "BUILD", "SIM_BUY", "SIM_CRAFT", "SIM_BUILD", "SIM_QUEST", "SIM_UPGRADE", "HUNT" };
